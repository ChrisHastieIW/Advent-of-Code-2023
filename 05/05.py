...
def map_seed_ranges(df_seed_ranges: pd.DataFrame, df_maps: pd.DataFrame):
  ...
  for counter in range(len(df_maps["mapping_destination"].unique())):
    ...
    # df_matched_records["mapping_source_range_start"] = df_matched_records["overlap_range_start"]
    # df_matched_records["mapping_range_length"] = df_matched_records["overlap_range_length"]
    # df_matched_records["mapping_destination_range_start"] = df_matched_records["destination_range_start"] + df_matched_records["overlap_range_start"] - df_matched_records["current_range_start"]
